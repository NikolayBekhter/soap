package ru.geekbrains.spring.ws.soap.configs;
...
public class WebServiceConfig extends WsConfigurerAdapter {
    @Bean
    public ServletRegistrationBean massageDispatcherServlet(ApplicationContext applicationContext) {
    ...
    //http://localhost:8181/ws/categories.wsdl
    ...
    public DefaultWsdl11Definition categoriesWsdl11Definition(XsdSchema categoriesSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://www.geekbrains.ru/spring/ws/soap/categories");
    ...
    public DefaultWsdl11Definition productsWsdl11Definition(XsdSchema productsSchema) {
        ...
        wsdl11Definition.setLocationUri("/ws");
        wsdl11Definition.setTargetNamespace("http://www.geekbrains.ru/spring/ws/soap/products");
